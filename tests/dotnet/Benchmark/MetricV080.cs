...
using Opentelemetry.V080.Proto.Collector.Metrics.V1;
using Opentelemetry.V080.Proto.Common.V1;
using Opentelemetry.V080.Proto.Metrics.V1;
using Opentelemetry.V080.Proto.Resource.V1;

namespace MetricBenchmark
{
    public class MetricV080 : IMetricBench
    {
        ...
        public MetricV080(bool isDouble, int numResources, int numLabels, int numLibs, int numMetrics, int numPoints)
        {
